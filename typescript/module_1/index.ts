...
new StockAnalysis('../data/stocks/Mid_Cap/MUTHOOTFIN.csv')
    .print()
    .write_csv('../data_output/week2/week2-typescript.csv')
    .write_stats('../data_output/week2/week2-typescript.json')
;
...
Promise.resolve(
    glob.sync("../data/stocks/**/*.csv")
        .map((input_csv) => {
            let output_csv = input_csv.replace('\.\./data/', '../data_output/week2/typescript/');
